      ...
      <div className="portfolio main" id="portfolio">
        <div className="port_container">
          ...
          <div className="card pornlo" onClick={() => setpon(!pornloon)}>
            <div
              className="content"
              style={{ transform: pornloon ? "rotateY(180deg)" : "" }}
            >
              <img
                src={require("../imgs/pornlo.png")}
                alt=""
                className="card__img"
              />
              ...
              <div className="card__text_front">
                ...
                <p className="card__body">
                  A platform for watching 18+ content.
                </p>
                <label>More</label>
              </div>
            ...
            <a
              href="https://pornlo.herokuapp.com/"
          ...
          <div className="card gallery" onClick={() => setgalon(!galon)}>
            <div
              className="content"
              style={{ transform: galon ? "rotateY(180deg)" : "" }}
            >
              <img
                src={require("../imgs/gallery.png")}
                alt=""
                className="card__img"
              />
              ...
              <div className="card__text_front">
                ...
                <p className="card__body">
                  A simple personal gallery built for an artist.
                </p>
                <label>More</label>
              </div>
            ...
            <a
              href="http://dylanz-art.herokuapp.com/"
              target="_blank"
              rel="noopener noreferrer"
              style={{ fontSize: "21px" }}
            >
